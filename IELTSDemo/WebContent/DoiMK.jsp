    ...
    <div class="container">
          <div class="row">
            ...
            <div class="content col-md-4 col-sm-4 col-xs-12">
              ...
              <form class="form-horizontal">
                <div class="form-group"> 
                  <h5><label class="control-label col-sm-2 col-sm-2 col-xs-2" for="current"><p style="color:cyan">Current</p></label></h5>
                  <div class="col-sm-10">
                    <input type="current" class="form-control" id="cr" placeholder="current">
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="content col-md-1 col-sm-1 col-xs-12">
              <h4><a href="DoiFullname.jsp"><span class="glyphicon glyphicon-pencil"></span></a>
              <h4><br>
              <h4><a href="DoiUsername.jsp"><span class="glyphicon glyphicon-pencil"></span></a>
              <h4><br>
              <h4><a href="DoiTel_num.jsp"><span class="glyphicon glyphicon-pencil"></span></a>
              <h4><br>
              <h4><a href="DoiDateBirth.jsp"><span class="glyphicon glyphicon-pencil"></span></a>
              <h4><br>
              ...
              <h4><br>
              <button type="button" class="btn btn-save"><a href="TrangDangNhapUser.jsp">Save</button></a>
              <br>
              <br>
