    ...
    <div class="container">
          <div class="row">
            <div class="content col-md-3 col-sm-3 col-xs-12 text-center">
              ...
              <br>
              <h4><span class="glyphicon glyphicon-pencil"></span></span><p style="color:red"> Change avatar</p><h4>
            </div> 
            <div class="content col-md-4 col-sm-4 col-xs-12">
              ...
              <form class="form-horizontal">
                <div class="form-group"> 
                  <h5><label class="control-label col-sm-2 col-sm-2 col-xs-2" for="current"><p style="color:cyan">Nationaly</p></label></h5>
                  <div class="col-sm-10">
                    <input type="nationaly" class="form-control" id="nt" placeholder="nationaly">
                  </div>
                </div>
              </form>
              <br>
