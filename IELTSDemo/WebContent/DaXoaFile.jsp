               ...
               <a href="UploadOther.jsp"><span class="glyphicon glyphicon-arrow-up  "></span></a>
                    ...
                    <div class="btn-group btn-group-justified" role="group" aria-label="...">
                        ...
                        <div class="btn-group" role="group">
                            <a href="MuFile.jspL"><button type="button" class="btn btn-primary">Listening</button></a>
                        </div>
                  ...
                  <h5><span class="label label-default">Progress : 0%</span><h5>
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        ...
                        <h3><div class="dropdown">
                            <button type="dropdown" class="btn btn-lg btn-save"><a href="SuaMyFile.html"><span class="glyphicon glyphicon-pencil"></span></button></a>
                                <div class="dropdown-content">
                                    <h4> <a href="ThongBaoXoaFile.jsp"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></h4>
                                    <h4><a href="ChiaSeFile.jsp"><span class="glyphicon glyphicon-share" aria-hidden="true"></span></a></h4>
