    ...
    <div class="container">
          <div class="row">
            ...
            <div class="content col-md-4 col-sm-4 col-xs-12">
              ...
              <form class="form-horizontal">
                <div class="form-group"> 
                  <h5><label class="control-label col-sm-2 col-sm-2 col-xs-2" for="current"><p style="color:cyan">Username</label></p></h5>
                  <div class="col-sm-10">
            ...
            <div class="content col-md-1 col-sm-1 col-xs-12">
              <h4><a href="DoiFullname.jsp"><span class="glyphicon glyphicon-pencil"></span><h4>
              <br>
              <br>
              <br>
              ...
              <br>
              <br>
              <button type="button" class="btn btn-cancel"><a href="MyProfile.jspl">Cancel</button></a>
              <br>
              <br>
