    ...
    <div class="container">
          <div class="row">
            <div class="content col-md-3 col-sm-3 col-xs-12 text-center">
              <img src="imgs/hoa.jpg" class="img-responsive" alt="hoa" width="304" height="236">
              <br>
              <h4><span class="glyphicon glyphicon-pencil"></span><p style="color:red"> Change avatar</p><h4>
            </div> 
            <div class="content col-md-4 col-sm-4 col-xs-12">
              <h4 style="color:black">Fullname: Phạm Xuân Hoàng<h4><br>
              <form class="form-horizontal">
                <div class="form-group"> 
                  <h5><label class="control-label col-sm-2 col-sm-2 col-xs-2" for="current"><p style="color:cyan">Fullname</p></label></h5>
                  <div class="col-sm-10">
                    <input type="fullname" class="form-control" id="fn" placeholder="fullname">
                  </div>
                </div>
              </form>
              <br>
            ...
            <div class="content col-md-1 col-sm-1 col-xs-12">
              ...
              <br>
              <br>
              <button type="button" class="btn btn-cancel"><a href="MyProfile.jsp">Cancel</button></a>
              <h4><a href="DoiUsername.jsp"><span class="glyphicon glyphicon-pencil"></span></a><h4>
              <br>
              <h4><a href="DoiTel_num.jsp"><span class="glyphicon glyphicon-pencil"></span></a><h4><br>
              <h4><a href="DoiDateBirth.jsp"><span class="glyphicon glyphicon-pencil"></span></a><h4>
              <br>
              <h4><a href="DoiNationaly.jsp"><span class="glyphicon glyphicon-pencil"></span></a><h4>
              <br>
              <h4><a href="DoiEmail.jsp"><span class="glyphicon glyphicon-pencil"></span><h4><br>
              <h4><a href="DoiMK.jsp"><span class="glyphicon glyphicon-pencil"></span></a><h4><br>
            </div>
