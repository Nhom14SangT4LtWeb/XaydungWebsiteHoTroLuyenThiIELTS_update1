    ...
    <div class="container">
          <div class="row">
            <div class="content col-md-3 col-sm-3 col-xs-12 text-center">
              <img src="imgs/exo1.jpg" class="img-responsive" alt="exo1" width="304" height="236">
              <br>
              <h4>
              <a href="ChangeAva.jsp"><span class="glyphicon glyphicon-pencil"></span><p style="color:red"> Change avatar
              </p><h4></a>
            </div> 
            ...
            <div class="content col-md-1 col-sm-1 col-xs-12">
              <h4 ><a href="DoiFullname.jsp"><p style="color:red"><span class="glyphicon glyphicon-pencil"></span></p><h4><br></a>
              <h4><a href="DoiUsername.jsp"><p style="color:red"><span class="glyphicon glyphicon-pencil"></span></p><h4><br></a>
              <h4><a href="DoiTel_num.jsp"><p style="color:red"><span class="glyphicon glyphicon-pencil"></span></p><h4><br></a>
              <h4><a href="DoiDateBirth.jsp"><p style="color:red"><span class="glyphicon glyphicon-pencil"></span></p><h4><br></a>
              <h4><a href="DoiNationaly.jsp"><p style="color:red"><span class="glyphicon glyphicon-pencil"></span></p><h4><br></a>
              <h4><a href="DoiEmail.jsp"><p style="color:red"><span class="glyphicon glyphicon-pencil"></span></p><h4><br></a>
              <h4><a href="DoiMK.jsp"><p style="color:red"><span class="glyphicon glyphicon-pencil"></span></p><h4></a>
            </div>
