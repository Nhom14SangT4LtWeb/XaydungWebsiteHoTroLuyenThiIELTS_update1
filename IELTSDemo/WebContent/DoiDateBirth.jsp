            ...
            <div>
              <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li><a href="MuFile.jsp">My File</a></li>
            ...
            <div class="container-fluid">
              <div class="clearfix visible-xs-block"></div>
                <ul class ="nav navbar-nav">
                  ...
                  <li>
                  <a href="Index.jsp">
                   <input class ="btn btn-default btn-sm" onclick='window.location="Index.jsp"'>
    ...
    <div class="container">
          <div class="row">
            <div class="content col-md-3 col-sm-3 col-xs-12 text-center">
              ...
              <br>
              <h4><span class="glyphicon glyphicon-pencil"></span><p style="color:red"> Change avatar
              </p><h4>
            </div> 
            <div class="content col-md-4 col-sm-4 col-xs-12">
              <h4 style="color:black">Fullname: Phạm Xuân Hoàng<h4><br>
              <h4 style="color:black"">Username: kemotsach<h4><br>
              <h4 style="color:black"">Telephone number: 0999999199919<h4><br>
              <h4 style="color:black"">Date of birth: 30/07/1996<h4><br>
              <form class="form-horizontal">
                <div class="form-group"> 
                  <h5><label class="control-label col-sm-2 col-sm-2 col-xs-2" for="current"><p style="color:cyan">Date of birth</label></p></h5>
                  <div class="col-sm-10">
                    <input type="telephone number" class="form-control" id="tn" placeholder="telephone number">
                  </div>
                </div>
              </form>
              <br>
              <br>
              <h4 style="color:black"">Nationaly: Vietnamese</h4><br>
              <h4 style="color:black"">Email: qwerty@gmail.com</h4><br>
              <h4 style="color:black"">Password: ************</h4>
            </div>
            <div class="content col-md-1 col-sm-1 col-xs-12">
              <h4><a href="DoiFullname.jsp"><span class="glyphicon glyphicon-pencil"></span></a></h4>
              <h4><br>
              <h4><a href="DoiUsername.jsp"><span class="glyphicon glyphicon-pencil"></span></a></h4>
              <h4><br>
              <h4><a href="DoiTel_num.jsp"><span class="glyphicon glyphicon-pencil"></span></a></h4>
              <h4><br>
              <br>
              <br>
              <button type="button" class="btn btn-save"><a href="MyProfile.jsp">Save</button></a>
              <br>
              <br>
              <button type="button" class="btn btn-cancel"><a href="MyProfile.html">Cancel</button></a>
              <br>
              <br>
              <h4><a href="DoiNationaly.jsp"><span class="glyphicon glyphicon-pencil"></span></a>
              </h4><br>
              <h4><a href="DoiEmail.jsp"><span class="glyphicon glyphicon-pencil"></span></a>
              </h4><br>
              <h4><a href="DoiMK.jsp"><span class="glyphicon glyphicon-pencil"></span></a>
              </h4><br>
            </div>
