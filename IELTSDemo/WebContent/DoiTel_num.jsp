    ...
    <div class="container">
          <div class="row">
            ...
            <div class="content col-md-4 col-sm-4 col-xs-12">
              ...
              <h4 style="color:yblack">Username: kemotsach<h4><br>
              <h4 style="color:black">Telephone number: 0999999199919<h4><br>
              <form class="form-horizontal">
                <div class="form-group"> 
                  <h5><label class="control-label col-sm-2 col-sm-2 col-xs-2" for="current"><p style="color:cyan">Telephone number</p></label></h5>
                  <div class="col-sm-10">
            ...
            <div class="content col-md-1 col-sm-1 col-xs-12">
              ...
              <br>
              <br>
              <button type="button" class="btn btn-save"><a href="MyProfile.html">Save</button></a>
              <br>
              <br>
              ...
              <h4><br>
              <h4><a href="DoiEmail.jsp"><span class="glyphicon glyphicon-pencil"></span></a><h4><br>
